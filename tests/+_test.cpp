...
int main(int ac, char ** av)
{
	...
	SUBCATEGORY(144, 150, cout << endl << FG_LGRAY << "subcategory: overload" << RESET_ALL << endl;)
	TEST(144, print(" %+ i ", 42));
	TEST(145, print(" %+ i ", -42));
	TEST(146, print(" %+ i ", 0));
	TEST(147, print(" %+ 10i ", 0));
	TEST(148, print(" %+ 010i ", 0));
	TEST(149, print(" %+ -10i ", 0));
	TEST(150, print(" %+ -010i ", 0));
	cout << ENDL;
	return (0);
}