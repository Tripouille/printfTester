...
int main(int ac, char ** av)
{
	...
	cout << endl;
	SUBCATEGORY(1, 4,  cout << FG_LGRAY << "subcategory: d" << RESET_ALL << endl;)
	...
	TEST(9, print(" %lu ", UINT_MAX));
	TEST(10, print(" %lu ", UINT_MAX + 1));
	TEST(11, print(" %lu ", -1));
	SUBCATEGORY(12, 14, cout << endl << FG_LGRAY << "subcategory: x" << RESET_ALL << endl;)
	TEST(12, print(" %lx ", UINT_MAX));
	TEST(13, print(" %lx ", UINT_MAX + 1));
	TEST(14, print(" %lx ", -1));
	SUBCATEGORY(15, 17, cout << endl << FG_LGRAY << "subcategory: X" << RESET_ALL << endl;)
	TEST(15, print(" %lX ", UINT_MAX));
	TEST(16, print(" %lX ", UINT_MAX + 1));
	TEST(17, print(" %lX ", -1));
